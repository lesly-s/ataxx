...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        if (Math.abs(_col0 - _col1) <= 1 && Math.abs(_row0 - _row1) <= 1) {
            _isExtend = true;
        }
    ...
    public String toString() {
        ...
        if (isPass()) {
            ...
            String c0 = String.valueOf(col0());
            String r0 = String.valueOf(row0());
            String c1 = String.valueOf(col1());
            String r1 = String.valueOf(row1());
            out.format(c0 + r0 + "-" + c1 + r1);
        }
        return out.toString();
    }
